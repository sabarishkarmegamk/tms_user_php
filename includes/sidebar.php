...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="index.php" class="nav-link">SIGNOUT here</a>
      </li>
      <!--li class="nav-item d-none d-sm-inline-block">
    ...
    {   ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="addcalls.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Add Management
              </p>
          ...
          <li class="nav-item">
            <a href="appoinments.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Appoinment Data
              </p>
          ...
          <li class="nav-item">
            <a href="notpick.php" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
              <p>
                Not_PICKED Data
              </p>
